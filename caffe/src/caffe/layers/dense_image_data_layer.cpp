...
//Manish : commented this check to make dense image data layer more general
...
//		<< "image heights and widths must match";
		...
		if (crop_size > 0) {
			...
			// similarly reshape label data blobs
			//Manish modified this from same height and width as data to
			// a different height and width of label
			top[1]->Reshape(batch_size, 1, cv_lab.rows, cv_lab.cols);
			this->prefetch_label_.Reshape(batch_size, 1, cv_lab.rows, cv_lab.cols);
...
//TODO:manish uncomment  this line
